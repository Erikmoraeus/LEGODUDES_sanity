...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-CCBWT7ph-FNZS4E7P.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-R1OQ_Aqq-SZMTHS5J.js")),
      options: config,
      router: route.create("/*")
    }],
    i18n: {
...
//# sourceMappingURL=chunk-CESQIC73.js.map
